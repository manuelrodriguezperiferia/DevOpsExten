...
declare function InternalStreamableUIClient<T>({ s, }: {
    s: StreamableValue<T>;
}): T | undefined;

export { InternalAIProvider, InternalStreamableUIClient, readStreamableValue, useAIState, useActions, useStreamableValue, useSyncUIState, useUIState };
